...
def predicciones_now(user_songs):
    ...
    scrap_odds =    {'Sweden 🇸🇪 ': 51.9333333333333,
                    'Finland 🇫🇮 ': 62.6666666666667,
                    'Ukraine 🇺🇦 ': 9.22666666666667,
                    'France 🇫🇷 ': 24.2666666666667,
                    'Israel 🇮🇱 ': 28,
                    'Spain 🇪🇸 ': 167.2,
                    'Norway 🇳🇴 ': 65.8,
                    'Italy 🇮🇹 ': 6.3,
                    'United Kingdom 🇬🇧 ': 65.1333333333333,
                    'Austria 🇦🇹 ': 60.9333333333333,
                    'Belgium 🇧🇪 ': 28.6,
                    'Armenia 🇦🇲 ': 116,
                    'Croatia 🇭🇷 ': 4.522,
                    'Australia 🇦🇺 ': 213.466666666667,
                    'Czechia 🇨🇿 ': 267.2,
                    'Switzerland 🇨🇭 ': 3.10133333333333,
                    'Germany 🇩🇪 ': 250.666666666667,
                    'Poland 🇵🇱 ': 226.733333333333,
                    'Slovenia 🇸🇮 ': 148,
                    'Cyprus 🇨🇾 ': 186.8,
                    'Moldova 🇲🇩 ': 306,
                    'Serbia 🇷🇸 ': 181.8,
                    'Estonia 🇪🇪 ': 166.666666666667,
                    'Portugal 🇵🇹 ': 286.8,
                    'Lithuania 🇱🇹 ': 65.8666666666667,
                    'Albania 🇦🇱 ': 286.8,
                    'Georgia 🇬🇪 ': 107.266666666667,
                    'Denmark 🇩🇰 ': 197.466666666667,
                    'Iceland 🇮🇸 ': 246.8,
                    'Greece 🇬🇷 ': 25.6666666666667,
                    'San Marino 🇸🇲 ': 323.466666666667,
                    'Netherlands 🇳🇱 ': 9.67333333333333,
                    'Ireland 🇮🇪 ': 59.9333333333333,
                    'Latvia 🇱🇻 ': 175,
                    'Azerbaijan 🇦🇿 ': 276.8,
                    'Malta 🇲🇹 ': 306.8,
                    'Romania 🇷🇴 ': 276.8
            ...
            with st.expander('Evolución Histórica de Puntos 🔢⏳', expanded=False): 
                ...
                for year in df['year'].unique():
                    ...
                    for country, points, color in zip(sorted_countries, sorted_points, bar_colors):
                        data.append(go.Bar(x=[year], y=[points], name=country, marker=dict(color=color, line=dict(color='black', width=1)), legendgroup=country, showlegend=False))
