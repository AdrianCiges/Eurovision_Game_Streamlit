...
def predicciones_now(user_songs):
    ...
    scrap_odds =    {'Sweden 🇸🇪 ': 1.474705882352941,
                     'Finland 🇫🇮 ': 3.75,
                     'Ukraine 🇺🇦 ': 10.5,
                     'France 🇫🇷 ': 19.794117647058822,
                     'Spain 🇪🇸 ': 19.88235294117647,
                     'Israel 🇮🇱 ': 26.0,
                     'Norway 🇳🇴 ': 29.529411764705884,
                     'United Kingdom 🇬🇧 ': 70.41176470588235,
                     'Italy 🇮🇹 ': 71.82352941176471,
                     'Austria 🇦🇹 ': 84.94117647058823,
                     'Czechia 🇨🇿 ': 104.6470588235294,
                     'Armenia 🇦🇲 ': 107.94117647058823,
                     'Croatia 🇭🇷 ': 140.2941176470588,
                     'Switzerland 🇨🇭 ': 167.0,
                     'Germany 🇩🇪 ': 182.58823529411765,
                     'Australia 🇦🇺 ': 199.64705882352942,
                     'Serbia 🇷🇸 ': 231.41176470588235,
                     'Moldova 🇲🇩 ': 247.88235294117646,
                     'Slovenia 🇸🇮 ': 252.0,
                     'Portugal 🇵🇹 ': 263.7647058823529,
                     'Poland 🇵🇱 ': 292.29411764705884,
                     'Cyprus 🇨🇾 ': 296.11764705882354,
                     'Belgium 🇧🇪 ': 266.70588235294116,
                     'Estonia 🇪🇪 ': 322.5882352941176,
                     'Georgia 🇬🇪 ': 324.05882352941177,
                     'Lithuania 🇱🇹 ': 342.6875,
                     'Denmark 🇩🇰 ': 359.3529411764706,
                     'Iceland 🇮🇸 ': 419.6470588235294,
                     'Greece 🇬🇷 ': 437.29411764705884,
                     'Albania 🇦🇱 ': 466.70588235294116,
                     'Romania 🇷🇴 ': 519.6470588235294,
                     'San Marino 🇸🇲 ': 519.6470588235294,
                    'Netherlands 🇳🇱 ' : 1000,
                    'Ireland 🇮🇪 ' : 1000,
                    'Latvia 🇱🇻 ' : 1000,
                    'Azerbaijan 🇦🇿 ' : 1000,
...
app_mode = st.sidebar.selectbox('Ir a:',['🎶 Juego Eurovisión', '🤖 Predicción Eurovisión 2023', '📊 Estadísticas 2002-2022' , '🤫 Oculto']) # , '🤫 Oculto'
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    user_songs = [
                          {'song': 'Duje', 'singer': 'Albina & Familja Kelmendi', 'country': 'Albania 🇦🇱 ', 'manager': 'J1'}, 
                          {'song': 'Blood & Glitter', 'singer': 'Lord of the Lost', 'country': 'Germany 🇩🇪 ', 'manager': 'J2'}, 
                          {'song': 'Future Lover', 'singer': 'Brunette', 'country': 'Armenia 🇦🇲 ', 'manager': 'J3'}, 
                          {'song': 'Promise', 'singer': 'Voyager', 'country': 'Australia 🇦🇺 ', 'manager': 'J4'}, 
                          {'song': 'Who the hell is Edgar?', 'singer': 'Teya & Selena', 'country': 'Austria 🇦🇹 ', 'manager': 'J5'}, 
