...
# ---------------------------------------------------------------------------------------------------------------------------
    ...
    movil = st.checkbox("Accedo desde un móvil")
  ...
  # ---- GRAFICOS PROMEDIO PUNTOS VS YOUTUBE ---------------------------------------------------------
    ...
    with st.expander('_Promedio de PUNTOS vs YouTube_', expanded=True): 
        ...
        fig.add_trace(px.bar(grouped_df, x='puntos_corregidos', y='country',
                      ...
                      row=1, col=1)
        if movil:
            fig.update_xaxes(title='Promedio de puntos', row=1, col=1, title_standoff=30, textangle=-30)
        else:
        ...
        fig.add_trace(px.bar(grouped_df, x='views', y='country',
                      ...
                      row=1, col=2)
        if movil:
            fig.update_xaxes(title='Promedio de reproducciones en YouTube', row=1, col=2, title_standoff=30, textangle=-30)
        else:
        ...
        fig.add_trace(px.bar(grouped_df, x='likes', y='country',
                      ...
                      row=1, col=3)
        if movil:
            fig.update_xaxes(title='Promedio de likes en YouTube', row=1, col=3, title_standoff=30, textangle=-30)
        else:          
