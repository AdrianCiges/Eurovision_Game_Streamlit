      ...
      # ---- GRAFICOS IDIOMAS ---------------------------------------------------------
        ...
        # -------HISTÓRICOS ----------------------------------------------------------------------
            ...
            with st.expander('Evolución Histórica de Puntos 🔢⏳', expanded=False): 
                ...
                'Bosnia and Herzegovina 🇧🇦 ': '#bcbd22','Bosn. & Herz. 🇧🇦 ': '#bcbd22', 'Bulgaria 🇧🇬 ': '#17becf', 'Croatia 🇭🇷 ': '#1f27b4', 'Cyprus 🇨🇾 ': '#ff7f0e',
                'Czechia 🇨🇿 ': '#2ca12c', 'Denmark 🇩🇰 ': '#d62628', 'Estonia 🇪🇪 ': '#9467bd', 'Finland 🇫🇮 ': '#60FDED',
                ...
                'Moldova 🇲🇩 ': '#bcbd22', 'Montenegro 🇲🇪 ': '#17becf', 'North Macedonia 🇲🇰 ': '#1f47b4','N. Macedonia 🇲🇰 ':'#1f37b4' ,'Norway 🇳🇴 ': '#ff4f0e',
                'Poland 🇵🇱 ': '#2ca22c', 'Portugal 🇵🇹 ': '#d62228', 'Romania 🇷🇴 ': '#9467bd', 'Russia 🇷🇺 ': '#FD606A',
